...
# Galactic transient distance band (eta Car at 2.3 kpc, hypothetical SN IIn at 2 kpc)
...
# Galactic transient label: rotated, in the empty mid-vertical region
ax.text(np.sqrt(1.5e-3 * 3.5e-3), 4e-12, r'Galactic ($\eta$\,Car / SN\,IIn)',
        ha='center', va='center', fontsize=9, color=C_GRAY,
        rotation=90, zorder=5)
# M31 SN IIn label
ax.text(np.sqrt(0.55 * 1.15), 4e-12, r'M31 SN\,IIn',
        ha='center', va='center', fontsize=9, color=C_GRAY,
        rotation=90, zorder=5)
